        ...
        <section className={styles.home} id="Home">
            <motion.div
                ...
                <motion.div className={styles.homeContent} variants={itemVariants}>
                    <h1>
                        Hi, it's <span className={styles.highlight}>Ahmed Rabea</span>
                    </h1>
                    <h3 className={styles.typingText}>
                        I'm a <span className={styles.typingHighlight}></span>
                    </h3>
                    <p>
                        a passionate and dedicated fourth-year Software Engineering student at NCT University, with a strong focus on web application development. Leading a team project,
                        I have successfully utilized HTML, CSS, JavaScript, PHP, and MySQL to create impactful solutions that meet user needs.
                    </p>
